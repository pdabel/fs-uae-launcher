...
2. **Fix client bug C1. — not started.** One-line change in `receive_thread` (`fs-uae/libfsemu/src/emu/netplay.c`); it makes every server, Python or Go, more robust over the internet.
